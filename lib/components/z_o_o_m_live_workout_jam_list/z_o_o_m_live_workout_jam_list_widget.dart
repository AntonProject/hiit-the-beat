                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${functions.getDayMonthTimeDateString(zoomJamItem.datetime!)} · ${zoomJamItem.free ? valueOrDefault<String>(
                                          ...
                                          FFLocalizations.of(context)
                                              .getVariableText(
                                            enText: 'Plusmembers Only',
                                            deText: 'Nur für Plusmembers',
                                            jaText: 'プラス会員限定',
                                          ),
                                          'Plusmembers Only',
                                        )}',
                            ...
                            children: [
                              Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    imageUrl: zoomJamItem.trainerAvatar,
                                    width: 36.0,
                                    height: 36.0,
                                    fit: BoxFit.cover,
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  logFirebaseEvent('Go_haptic_feedback');
                                  ...
                                  if (!zoomJamItem.free) {
                                    if (!valueOrDefault<bool>(
                                      ...
                                      if (valueOrDefault<bool>(
                                              ...
                                              false) ==
                                          false) {
                                        logFirebaseEvent('Go_bottom_sheet');
