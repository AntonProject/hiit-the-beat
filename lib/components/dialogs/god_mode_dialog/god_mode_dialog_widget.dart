...
class _GodModeDialogWidgetState extends State<GodModeDialogWidget> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () async {
        logFirebaseEvent('GOD_MODE_DIALOG_Column_sincpzmx_ON_TAP');
                  ...
                  children: [
                    Align(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'GOD_MODE_DIALOG_Container_28xdzhdh_ON_TA');
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'GOD_MODE_DIALOG_COMP_Goback_ON_TAP');
                          logFirebaseEvent('Goback_haptic_feedback');
                          HapticFeedback.selectionClick();
                          logFirebaseEvent('Goback_bottom_sheet');
                          Navigator.pop(context);
                        },
