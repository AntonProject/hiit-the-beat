...
import 'onboarding_home_step2_model.dart';
export 'onboarding_home_step2_model.dart';

class OnboardingHomeStep2Widget extends StatefulWidget {
  const OnboardingHomeStep2Widget({super.key});

  @override
  State<OnboardingHomeStep2Widget> createState() =>
      _OnboardingHomeStep2WidgetState();
}

class _OnboardingHomeStep2WidgetState extends State<OnboardingHomeStep2Widget>
    with TickerProviderStateMixin {
  late OnboardingHomeStep2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnboardingHomeStep2Model());
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        FFLocalizations.of(context).getText(
                          'a17hnqx5' /* The workout collections sectio... */,
                        ),
                                  ...
                                  showModalBottomSheet(
                                    ...
                                    builder: (context) {
                                      return Padding(
                                        ...
                                        child: OnboardingHomeStep1Widget(),
                                      );
                                    },
                            ...
                            Expanded(
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  _model.count = await queryWorkoutsRecordCount(
