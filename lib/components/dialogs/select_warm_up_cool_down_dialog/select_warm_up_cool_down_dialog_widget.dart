...
class _SelectWarmUpCoolDownDialogWidgetState
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () async {
        logFirebaseEvent('SELECT_WARM_UP_COOL_DOWN_DIALOG_Column_7');
                  ...
                  children: [
                    Align(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'SELECT_WARM_UP_COOL_DOWN_DIALOG_Containe');
                            ...
                            builder: (context) {
                              final containerVar =
                                  containerAdditionalsRecordList
                                      .where((e) => FFLocalizations.of(context)
                                                  .languageCode ==
                                              'en'
                                          ? (e.en || (e.en && e.de))
                                          : (e.de || (e.en && e.de)))
                              ...
                              return ListView.separated(
                                ...
                                itemBuilder: (context, containerVarIndex) {
                                  ...
                                  return wrapWithModel(
                                    model: _model.additionalCompDialogModels
                                        .getModel(
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'SELECT_WARM_UP_COOL_DOWN_DIALOG_Close_ON');
