...
import 'onboarding_home_step3_model.dart';
export 'onboarding_home_step3_model.dart';

class OnboardingHomeStep3Widget extends StatefulWidget {
  const OnboardingHomeStep3Widget({
    super.key,
    required this.seasonDoc,
    int? workoutCount,
  }) : this.workoutCount = workoutCount ?? 0;

  final SeasonsRecord? seasonDoc;
  final int workoutCount;

  @override
  State<OnboardingHomeStep3Widget> createState() =>
      _OnboardingHomeStep3WidgetState();
}

class _OnboardingHomeStep3WidgetState extends State<OnboardingHomeStep3Widget>
    with TickerProviderStateMixin {
  late OnboardingHomeStep3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnboardingHomeStep3Model());
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        FFLocalizations.of(context).getText(
                          'wr5t2ojx' /* On the season screen, basic in... */,
                        ),
                                ...
                                onPressed: () async {
                                  ...
                                  _model.workout =
                                    ...
                                    queryBuilder: (workoutsRecord) =>
                                      ...
                                      'season_id',
                                      isEqualTo:
                                          widget!.seasonDoc?.reference.id,
                                    ),
                                    singleRecord: true,
                                  ).then((s) => s.firstOrNull);
                                  logFirebaseEvent('next_firestore_query');
                                  _model.progress =
                                      await queryProgressRecordOnce(
