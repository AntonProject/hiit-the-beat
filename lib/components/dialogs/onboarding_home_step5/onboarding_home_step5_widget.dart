...
import 'onboarding_home_step5_model.dart';
export 'onboarding_home_step5_model.dart';

class OnboardingHomeStep5Widget extends StatefulWidget {
  const OnboardingHomeStep5Widget({
    super.key,
  ...
  @override
  State<OnboardingHomeStep5Widget> createState() =>
      _OnboardingHomeStep5WidgetState();
}

class _OnboardingHomeStep5WidgetState extends State<OnboardingHomeStep5Widget>
    with TickerProviderStateMixin {
  late OnboardingHomeStep5Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnboardingHomeStep5Model());
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            '6clf8prb' /* That's it.  Let's start the fi... */,
                          ),
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'ONBOARDING_HOME_STEP5_COMP_Letsgo_ON_TAP');
                          ...
                          children: [
                            ...
                            Expanded(
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'ONBOARDING_HOME_STEP5_COMP_next_ON_TAP');
