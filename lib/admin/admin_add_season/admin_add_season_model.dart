...
class AdminAddSeasonModel extends FlutterFlowModel<AdminAddSeasonWidget> {
  ...
  bool isDataUploading_uploadDataCoverSeasonAdd = false;
  FFUploadedFile uploadedLocalFile_uploadDataCoverSeasonAdd =
      FFUploadedFile(bytes: Uint8List.fromList([]), originalFilename: '');
  String uploadedFileUrl_uploadDataCoverSeasonAdd = '';
