...
class _AdminAddSeasonWidgetState extends State<AdminAddSeasonWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'AdminAddSeason'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('ADMIN_ADD_SEASON_AdminAddSeason_ON_INIT_');
      logFirebaseEvent('AdminAddSeason_custom_action');
      unawaited(
        () async {
                    ...
                    Row(
                      ...
                      children: [
                        FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            logFirebaseEvent(
                                'ADMIN_ADD_SEASON_arrowLeft24_ICN_ON_TAP');
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'ADMIN_ADD_SEASON_PAGE_Create_ON_TAP');
                                    ...
                                    return Row(
                                      ...
                                      children: List.generate(levels.length,
                                        ...
                                        return FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'ADMIN_ADD_SEASON_PAGE_Beginner_ON_TAP');
                                            logFirebaseEvent(
                              ...
                              child: Row(
                                ...
                                children: [
                                  FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'ADMIN_ADD_SEASON_PAGE_EN_ON_TAP');
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'ADMIN_ADD_SEASON_PAGE_DE_ON_TAP');
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'ADMIN_ADD_SEASON_PAGE_JA_ON_TAP');
                                                ...
                                                children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: FFButtonWidget(
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'ADMIN_ADD_SEASON_PAGE_Uploadcover_ON_TAP');
                                                        logFirebaseEvent(
                                                        ...
                                                        if (selectedMedia !=
                                                            ...
                                                            selectedMedia.every((m) =>
                                                                validateFileFormat(
                                                                    ...
                                                                    context))) {
                                                          safeSetState(() =>
                                                              _model.isDataUploading_uploadDataCoverSeasonAdd =
                                                                  true);
                                                          ...
                                                          if (selectedUploadedFiles
                                                              ...
                                                              downloadUrls
                                                                  ...
                                                                  selectedMedia
                                                                      .length) {
                                                            safeSetState(() {
                                                              _model.uploadedLocalFile_uploadDataCoverSeasonAdd =
                                                                  selectedUploadedFiles
                                                                      .first;
                                                              _model.uploadedFileUrl_uploadDataCoverSeasonAdd =
                                                                  downloadUrls
                                                                      .first;
                                                            });
                                                          } else {
                                                        ...
                                                        if ((_model.uploadedFileUrl_uploadDataCoverSeasonAdd !=
                                                                    null &&
                                                                _model.uploadedFileUrl_uploadDataCoverSeasonAdd !=
                                                                    '') &&
                                                            !_model
                                                                .isDataUploading_uploadDataCoverSeasonAdd) {
                                                          logFirebaseEvent(
                                                              'Uploadcover_update_page_state');
                                                          _model.cover = _model
                                                              .uploadedFileUrl_uploadDataCoverSeasonAdd;
                                                          safeSetState(() {});
                                                        }
                                                      },
                                                  ...
                                                  if (_model.cover != null &&
                                                    ...
                                                    FFButtonWidget(
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'ADMIN_ADD_SEASON_PAGE_Delete_ON_TAP');
                                                        logFirebaseEvent(
