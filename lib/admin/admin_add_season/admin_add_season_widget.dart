...
import 'admin_add_season_model.dart';
export 'admin_add_season_model.dart';

class AdminAddSeasonWidget extends StatefulWidget {
  const AdminAddSeasonWidget({super.key});

  static String routeName = 'AdminAddSeason';
  static String routePath = '/adminAddSeason';

  @override
  State<AdminAddSeasonWidget> createState() => _AdminAddSeasonWidgetState();
}

class _AdminAddSeasonWidgetState extends State<AdminAddSeasonWidget>
    with TickerProviderStateMixin {
  late AdminAddSeasonModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminAddSeasonModel());
                                ...
                                return GestureDetector(
                                  ...
                                  child: Padding(
                                    ...
                                    child: AdminSaveDialogWidget(
                                      actionTrue: () async {
                                        await SeasonsRecord.collection
                                            .doc()
                                            .set(createSeasonsRecordData(
                          ...
                          onPressed: () async {
                            await SeasonsRecord.collection
                                ...
                                .set(createSeasonsRecordData(
                                  ...
                                  number: int.tryParse(
                                      _model.numberTextController.text),
                                  releasedAt: _model.datePicked != null
                                      ? _model.datePicked
                                      : getCurrentTimestamp,
                                  en: _model.en,
                                  de: _model.de,
