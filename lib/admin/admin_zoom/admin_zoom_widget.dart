                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            await widget!.zoom2!.reference
                                .update(createAdditionalsRecordData(
                              titleEn: _model.textEn2TextController.text,
                              titleDe: _model.textDe2TextController.text,
                              linkURL: _model.link2TextController.text,
                              descEn: _model.descEn2TextController.text,
                              descDe: _model.descDe2TextController.text,
                              datetime: _model.dateTimeZoom2,
                              free: _model.freeSwitch2Value,
                              titleJa: _model.textJa2TextController.text,
                              descJa: _model.descJa2TextController.text,
                              trainerNameAndSurname: _model
                                  .trainerNameAndSurname2TextController.text,
                            ));
                            if (_model.hasNewTrainerAvatar2 &&
                                (_model.localTrainerAvatar2 != null &&
                                    (_model.localTrainerAvatar2?.bytes
                                            ?.isNotEmpty ??
                                        false))) {
                              logFirebaseEvent('Save_backend_call');
                                            ...
                                            return Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  ...
                                                  _model.localTrainerAvatar = _model
